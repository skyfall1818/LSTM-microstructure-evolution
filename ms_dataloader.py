        ...
        for _ in range(self.n_frames_total):
          ...
          if not file_exists:
            ...
            if image.size[0] == 1520:
                ...
                #count += 1
                #if count % 20 == 0:
                #    print('20 size anomalies, file should be skipped:', self.imagefile_template.format(frame_idx),' at:',image.size[0],' from :', os.path.join(sample.path, self.imagefile_template.format(frame_idx)))
