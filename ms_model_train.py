...
def main():
    ...
    if use_cuda:
        tot_frames, batch_size, num_epochs, learning_rate = 20, 8, 5, 1e-3
    else:
    ...
    train_data = MicroS_Dataset(
        ...
        imagefile_template='Frame-{:d}.jpeg',
        transform=transform,
        is_train=True
    )
        ...
        for _, (input_batch, output_batch) in enumerate(train_dataloader):
            ...
            if ((batch_ct + 1) % 25) == 0:
                ...
                print('Epoch: {}/{}, Step: {}/{}, Loss: {}'.format(
                        epoch, num_epochs, (batch_ct % len(train_dataloader)), len(train_dataloader), loss.item()))
